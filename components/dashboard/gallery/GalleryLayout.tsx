...
import { useGalleryState } from '@/components/dashboard/gallery/lib/useGallery'

import FormModal from '@/components/dashboard/gallery/modal/FormModal'

import DeleteModal from '@/components/dashboard/gallery/modal/DeleteModal'
                    ...
                    {isLoading ? (
                        ...
                        <div className="col-span-full p-8 text-center border rounded-xl bg-card shadow-sm">
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <h3 className="text-xl font-semibold text-muted-foreground mb-2">No Galleries Found</h3>
                                <p className="text-muted-foreground">Start by creating your first gallery item using the &quot;Create Content&quot; button above.</p>
                            </div>
                        </div>
                    ) : (
                        currentGalleries.map((gallery) => (
                            <div key={gallery._id} className="p-4 sm:p-6 border rounded-xl bg-card shadow-sm hover:shadow-md transition-all">
                                <div className="flex flex-col gap-4 sm:gap-6">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex flex-col justify-between items-start gap-4">
                                            <div className="space-y-2 w-full">
                                                <h4 className="text-lg sm:text-xl font-bold">{gallery.title}</h4>
                                            </div>
                                            <div className="flex gap-3 w-full">
                                                <Button
                                                    variant="outline"
                                                ...
                                                <Button
                                                    variant="destructive"
                                                    size="lg"
                                                    onClick={() => gallery._id && openDeleteDialog(gallery._id)}
                                                    className="flex-1"
                                                >
                                                    Delete
                                                </Button>
